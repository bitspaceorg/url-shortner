...
export default function Redirect (p:InferGetServerSidePropsType<typeof getServerSideProps>){
    ...
    <div className="w-screen h-screen">
        {isValid ? <div>Redirecting {p.data.long}</div> : <div className="flex flex-col items-center justify-center w-full h-full">The link you entered is not available</div>}
        </div>
	)
}
